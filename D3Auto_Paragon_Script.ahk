...
;-----------------
    ...
    nomePerfil1 := "xxxxx"
    habilidade1TempoPerfil1 := 100
    habilidade2TempoPerfil1 := 0
    habilidade3TempoPerfil1 := 200
    habilidade4TempoPerfil1 := 0

    nomePerfil2 := "xxxxx"
    habilidade1TempoPerfil2 := 0
    habilidade2TempoPerfil2 := 100
    habilidade3TempoPerfil2 := 0
    habilidade4TempoPerfil2 := 200

    nomePerfil3 := "xxxxx"
    habilidade1TempoPerfil3 := 0
    habilidade2TempoPerfil3 := 0
    habilidade3TempoPerfil3 := 0
    habilidade4TempoPerfil3 := 0

    nomePerfil4 := "xxxxx"
    habilidade1TempoPerfil4 := 0
    habilidade2TempoPerfil4 := 0
    habilidade3TempoPerfil4 := 0
    habilidade4TempoPerfil4 := 0
