...
Global sequenciadorAutomaticoComTempo, sequenciadorAutomaticoComTempo := 0 ; 0 sem temporizador 1 com temporizador
...
criaJanelaConfiguracao()
{
    ...
    Gui, Add, Text, x30 y230, Control+F6 a Control+F8 (Atalho Automatizado 1 a 4) 
